...
public class CppUnrealEngineClientCodegen extends AbstractCppCodegen {
    ...
    public String getName() {
        return "cpp-unrealengine-client";
    }
    ...
    public String getHelp() {
        return "Generate Client for Unreal Engine HTTP";
    }
    ...
    public CppUnrealEngineClientCodegen() {
        ...
        modelTemplateFiles.put("model-unreal-header.mustache", ".h");
        modelTemplateFiles.put("model-unreal-source.mustache", ".cpp");

        apiTemplateFiles.clear();
        apiTemplateFiles.put("api-unreal-header.mustache", ".h");
        apiTemplateFiles.put("api-unreal-source.mustache", ".cpp");

        embeddedTemplateDir = templateDir = "cpp-unrealengine-client";
        ...
        supportingFiles.add(new SupportingFile("apiclient-unreal-header.mustache", "", "ApiClient.h"));
        supportingFiles.add(new SupportingFile("apiclient-unreal-source.mustache", "", "ApiClient.cpp"));
        ...
        typeMapping.put("ByteArray", "FString");
    ...
    public String toOperationId(String operationId) {
        ...
        return StringUtils.camelize(sanitizeName(super.toOperationId(operationId)));
    }
    @Override
    ...
    public String toModelFilename(String name) {
        return sanitizeName(StringUtils.camelize(name));
    }

    @Override
    public String toApiFilename(String name) {
        return sanitizeName(StringUtils.camelize(name) + "Api");
    }
