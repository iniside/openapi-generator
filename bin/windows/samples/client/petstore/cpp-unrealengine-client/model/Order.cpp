...
void Order::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_PetIdIsSet)
    {
        if (m_PetId.get())
        {
            m_PetId->toMultipart(multipart, utility::conversions::to_string_t("petId."));
        }
    }
    if(m_QuantityIsSet)
    {
...
void Order::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("petId")))
    {
        ...
        {
            std::shared_ptr<int64> newItem(0L);
            newItem->fromMultiPart(multipart, utility::conversions::to_string_t("petId."));
            setPetId( newItem );
        }
    }
...
std::shared_ptr<int64> Order::getId() const
{
    return m_Id;
}

void Order::setId(const std::shared_ptr<int64>& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
std::shared_ptr<int64> Order::getPetId() const
{
    return m_PetId;
}

void Order::setPetId(const std::shared_ptr<int64>& value)
{
    m_PetId = value;
    m_PetIdIsSet = true;
}
...
std::shared_ptr<int32> Order::getQuantity() const
{
    return m_Quantity;
}

void Order::setQuantity(const std::shared_ptr<int32>& value)
{
    m_Quantity = value;
