...
std::shared_ptr<int64> Pet::getId() const
{
    return m_Id;
}

void Pet::setId(const std::shared_ptr<int64>& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
TArray<std::shared_ptr<Tag>>& Pet::getTags()
{
    return m_Tags;
}

void Pet::setTags(const TArray<std::shared_ptr<Tag>>& value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}
