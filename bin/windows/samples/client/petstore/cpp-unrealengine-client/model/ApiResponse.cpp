...
void ApiResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("code")))
    {
        ...
        {
            std::shared_ptr<int32> newItem(0);
            newItem->fromMultiPart(multipart, utility::conversions::to_string_t("code."));
            setCode( newItem );
        }
    }
...
std::shared_ptr<int32> ApiResponse::getCode() const
{
    return m_Code;
}

void ApiResponse::setCode(const std::shared_ptr<int32>& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
