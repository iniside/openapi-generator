...
pplx::task<void> StoreApi::deleteOrder(FString orderId)
{
...
pplx::task<TMap<utility::string_t, std::shared_ptr<int32>>> StoreApi::getInventory()
{
    ...
    .then([=](utility::string_t localVarResponse)
    {
        TMap<utility::string_t, std::shared_ptr<int32>> localVarResult;
        ...
        if(localVarResponseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<int32> localVarItemObj(0);
...
pplx::task<std::shared_ptr<Order>> StoreApi::getOrderById(std::shared_ptr<int64> orderId)
{
