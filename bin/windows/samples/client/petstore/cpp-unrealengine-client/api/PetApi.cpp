...
pplx::task<void> PetApi::deletePet(std::shared_ptr<int64> petId, boost::optional<FString> apiKey)
{
...
pplx::task<TArray<std::shared_ptr<Pet>>> PetApi::findPetsByStatus(TArray<FString> status)
{
    ...
    .then([=](utility::string_t localVarResponse)
    {
        TArray<std::shared_ptr<Pet>> localVarResult;
...
pplx::task<TArray<std::shared_ptr<Pet>>> PetApi::findPetsByTags(TArray<FString> tags)
{
...
pplx::task<std::shared_ptr<Pet>> PetApi::getPetById(std::shared_ptr<int64> petId)
{
...
pplx::task<void> PetApi::updatePetWithForm(std::shared_ptr<int64> petId, boost::optional<FString> name, boost::optional<FString> status)
{
...
pplx::task<std::shared_ptr<ApiResponse>> PetApi::uploadFile(std::shared_ptr<int64> petId, boost::optional<FString> additionalMetadata, boost::optional<std::shared_ptr<HttpContent>> file)
{
