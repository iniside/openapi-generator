...
pplx::task<void> UserApi::createUsersWithArrayInput(TArray<std::shared_ptr<User>> body)
{
...
pplx::task<void> UserApi::createUsersWithListInput(TArray<std::shared_ptr<User>> body)
{
...
pplx::task<void> UserApi::deleteUser(FString username)
{
...
pplx::task<std::shared_ptr<User>> UserApi::getUserByName(FString username)
{
...
pplx::task<FString> UserApi::loginUser(FString username, FString password)
{
    ...
    .then([=](utility::string_t localVarResponse)
    {
        FString localVarResult(utility::conversions::to_string_t(""));
...
pplx::task<void> UserApi::updateUser(FString username, std::shared_ptr<User> body)
{
